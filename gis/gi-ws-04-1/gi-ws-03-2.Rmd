...
This was one of the most difficult tasks but we managed it (without any help from mister Reudenbach(;). Is there a way to use somethinhg like paste0 to make funktions look a little more user friendly?
