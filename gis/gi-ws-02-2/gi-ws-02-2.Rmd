...
So it is more than a pattern and there is also something like scale that matters.
That is why it still needs a human to define the conditions for an entity being part of a landform category.
