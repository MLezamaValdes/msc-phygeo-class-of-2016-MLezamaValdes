...
#Blatt 7 1 mit r², Funktion so lange aufgerufen bis Modell mit optimal selektierten
#Variablen
#markdown, Inhalt des letzten FUnktionsaufrufs ausgeben (in VAriable schreiben)
# 2 Variablen bleiben nicht selektiert übrig