pfad <- setwd("C:/Users/Michaela Vorndran/Dropbox/Studium/Master/Datenanalyse/Github/msc-phygeo-class-of-2016-MVorndran/data_analysis/data/dwd_stationsdaten_3164_coelbe/")
dat <- read.csv(paste0(pfad, "/produkt_synop_Terminwerte_20060701_20151231_03164.txt"), sep = ";", header = TRUE)
