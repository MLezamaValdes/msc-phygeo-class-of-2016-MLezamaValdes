...
```{r}
path_main <- "E:/da_jetzt/"
path_data <- paste0(path_main, "2016-data-analysis/data/csv/")
path_rdata <- paste0(path_main, "2016-data-analysis/data/rdata/")
source(paste0(path_main,"msc-phygeo-class-of-2016-MLezamaValdes/data-analysis/da-ws-04-2/function_04_2.R"))        

#Tabelle Flächennutzung
...
head(fn_final)
#save
saveRDS(fn_final,paste0(path_rdata,"da-ws-04-2.rds"))
#test <- readRDS(paste0(path_rdata,"da-ws-04-2.rds"))
