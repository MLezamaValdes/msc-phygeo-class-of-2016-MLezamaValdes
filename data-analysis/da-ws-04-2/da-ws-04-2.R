#paths
path_main <- "C:/Users/sleza/Documents/Lilian/2016-data-analysis/" 
path_data <- paste0(path_main, "data/")
path_csv <- paste0(path_data, "csv/")
path_rdata <- paste0(path_data, "rdata/")
path_repo <- "C:/Users/sleza/Documents/Lilian/msc-phygeo-class-of-2016-MLezamaValdes/data-analysis/da-ws-04-2/"
...
save("place_sep", file=paste0(path_repo,"place_sep_func.R"))
###---

load(paste0(path_repo, "place_sep_func.R"))
#run function
...
names(aiclo)
names(aiclo) <- c("ID", "Year", "Place_name", "attribute_1", "attribute_2", 
                  "Place", "share_settlement_transport_infrastructure_in_total_areas"
                  , "share_recreational_in_total_areas"                       
                  , "share_agric_in_total_areas"                              
                  , "share_forests_in_total_areas" )
saveRDS(aiclo,paste0(path_repo,"AI001_clean.rds"))
AI001 <- readRDS(paste0(path_repo,"AI001_clean.rds"))
head(AI001)
