...
```
####The optimal selection of variables would be winter barley, potatoes, rapeseed, 
####oat, rye, silage maize and triticale in this order to predict winter wheat 
####in a multiple regression model. Spring barley and sugar beets ought to be 
####excluded in order to avoid overfitting and maintain the optimal adj.R² of 0.7112. 
